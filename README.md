...
1. [Полезные знания](https://github.com/VladJutnik/useful/blob/main/README.md). Тут собраны полезные замечания примеры, с которыеми встечался в своей работе
2. [Примеры запросов](https://github.com/VladJutnik/sql_request/blob/master/Анкета%20директоров%20у%20которых%20не%20сходиться%20муниципальное%20образование%20.sql). Тут собраны примеры запросов sql, с которыеми встечался в своей работе
